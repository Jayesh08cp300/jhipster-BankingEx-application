...
import com.pmc.bankapp.domain.Customer;
import com.pmc.bankapp.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer().fullName(DEFAULT_FULL_NAME).address(DEFAULT_ADDRESS).mobileNo(DEFAULT_MOBILE_NO);
        return customer;
    }
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer().fullName(UPDATED_FULL_NAME).address(UPDATED_ADDRESS).mobileNo(UPDATED_MOBILE_NO);
        return customer;
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        updatedCustomer.fullName(UPDATED_FULL_NAME).address(UPDATED_ADDRESS).mobileNo(UPDATED_MOBILE_NO);
    ...
    void fullUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.fullName(UPDATED_FULL_NAME).address(UPDATED_ADDRESS).mobileNo(UPDATED_MOBILE_NO);
