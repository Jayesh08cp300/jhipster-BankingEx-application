...
import com.pmc.bankapp.domain.Transaction;
import com.pmc.bankapp.repository.TransactionRepository;
...
class TransactionResourceIT {
    ...
    public static Transaction createEntity(EntityManager em) {
        Transaction transaction = new Transaction().amount(DEFAULT_AMOUNT);
        return transaction;
    }
    ...
    public static Transaction createUpdatedEntity(EntityManager em) {
        Transaction transaction = new Transaction().amount(UPDATED_AMOUNT);
        return transaction;
    }
