package com.pmc.bankapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.pmc.bankapp.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.pmc.bankapp.repository.UserRepository.USERS_BY_EMAIL_CACHE);
